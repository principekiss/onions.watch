...
This project is a copy of [dark.fail](https://dark.fail) and aims to provide a codebase to allow anyone to create their own information site about [onion services](https://community.torproject.org/onion-services/) as well.
